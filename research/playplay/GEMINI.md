...
*   **Punto de partida:** Lee `README.md` (en la raíz) primero — es el paquete de handoff, explica en un párrafo qué es esto y cómo navegar el resto de la carpeta, sin asumir contexto previo.
...
*   **Revisión Histórica:** Lee `docs/WINDOWS_WORK_SUMMARY.md`, `docs/PLAYPLAY_ARCHITECTURE_NOTES.md` y `docs/FACTS.md` para entender por qué ciertas decisiones arquitectónicas ya se han tomado.
