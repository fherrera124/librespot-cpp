...
if ($hwnd -ne [IntPtr]::Zero) {
    ...
    Write-Output "Sent Play/Pause" | Out-File -FilePath "C:\Users\francisco.herrera\play_log.txt"
} else {
    Write-Output "Spotify window not found" | Out-File -FilePath "C:\Users\francisco.herrera\play_log.txt"
}
