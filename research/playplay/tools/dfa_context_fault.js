...
setImmediate(() => {
    try {
        ...
        // 2. Fault the context at different offsets
        // Let's fault bytes near the end of the round keys (around offset 0x40 to 0x5C)
        // We'll just generate faults for offsets 0x40 to 0x60
