...
// cJSON only, matching DealerClient - this project always builds
// BELL_ONLY_CJSON, and the context-resolve response is protobuf's
// canonical JSON mapping, not nanopb-decodable.
#include "cJSON.h"
